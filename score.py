...
if __name__=='__main__':
    ...
    ##SS
    for method in ['final_project_AVSE_audio_only_stoiloss_version01-epoch=99-val_loss=0','final_project_AVSE_audio_visual_stoiloss_version01-epoch=29-val_loss=0','final_project_AVSE_audio_visual_stoiloss_speech_separation_version_Pat-last']:
